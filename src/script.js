...
const skillsData = {
    CSS: {
        icon: `<div class="w-32 h-32 bg-gradient-to-tr from-white to-blue-300 rounded-full flex items-center justify-center p-5 inset-shadow-pink-500">
    ...
    React: {
        icon:`<div class="w-32 h-32 bg-gradient-to-tr from-white to-blue-300 rounded-full flex items-center justify-center p-2">
              ...
              <div><p class="neon-text text-3xl">React</p></div>`,
        description: "TODO",
    },
    Tailwind: {
        icon:`<div class="w-32 h-32 bg-gradient-to-tr from-white to-blue-300 rounded-full flex items-center justify-center p-2">
...
document.getElementById('contact-form')?.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        const response = await fetch('https://api.jankulak.me/api/contact/', {
            method: 'POST',
            headers: {
